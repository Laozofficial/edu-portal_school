                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('/dashboard/admin/school')}}" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{url('/dashboard/admin/add-school')}}"><i class="lni lni-plus"></i> Add School</a></li>
                            <li><a href="{{url('/dashboard/admin/all-schools')}}"><i class="lni lni-list"></i> All Schools</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('/dashboard/admin/academic')}}" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('/dashboard/admin/grade-scale')}}"><i class="lni lni-network"></i> Grade Scale</a></li>
                             <li><a class="has-arrow ai-icon" aria-expanded="false">
                                ...
                                <ul aria-expanded="false">
                                    <li><a href="{{url('/dashboard/admin/assessment-types')}}"><i class="lni lni-list"></i> Assessment Types</a></li>
                                    <li><a href="{{url('/dashboard/admin/add-assessment')}}"><i class="lni lni-plus"></i> Enter Assessment Score</a></li>
                                </ul>
                            </li>
                            <li><a href="{{url('/dashboard/admin/time-table')}}"><i class="lni lni-paperclip"></i> Time Table</a></li>
                            <li><a href="{{url('/dashboard/admin/assignment')}}"><i class="lni lni-customer"></i> Assignments</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{url('/dashboard/admin/teachers')}}" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('/dashboard/admin/add-teacher')}}"><i class="lni lni-plus"></i> Add Teachers</a></li>
                        </ul>
                    </li>
