...
<head>
        ...
        <!-- plugin css -->
        <link href="{{asset('edu_portal/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
  ...
  <body>
       ...
       <div id="layout-wrapper">
        @include('edu_portal.admin.partials.header')

        @include('edu_portal.admin.partials.sidenav')
         ...
         <!-- ============================================================== -->
            ...
            <div class="main-content">
                ...
                @include('edu_portal.admin.partials.footer')
            </div>
        ...
        <!-- Plugins js-->
        <script src="{{asset('edu_portal/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
        <script src="{{asset('edu_portal/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js')}}"></script>
        <!-- dashboard init -->
