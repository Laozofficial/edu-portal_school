...
<body>
    ...
    <div id="layout-wrapper">
        @include('edu_portal.student.partials.nav')

        @include('edu_portal.student.partials.sidenav')
        ...
        <div class="main-content">
            ...
            @include('edu_portal.Student.partials.footer')
        </div>
    ...
    <script>
        const base_url = "{{ url('/api/dashboard/student/') }}";
