              ...
              <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <!-- <li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         <li><a href="{{url('/dashboard/teacher/academic-session')}}"><i
                                     class="lni lni-school-bench-alt"></i> Academic Session</a></li>
                         <!--<li><a href="{{url('/dashboard/teacher/term')}}"><i class="lni lni-blackboard"></i> Terms</a>
                         </li>-->
                        <!--<li><a href="{{url('/dashboard/teacher/subjects')}}"><i class="lni lni-book"></i> Subjects</a>
                         </li>-->
                 ...
                 <li><a class="has-arrow ai-icon" href="javascript: void(0);" aria-expanded="false">
                     ...
                     <ul aria-expanded="false">
                        ...
                        <!-- <li><a href="{{url('/dashboard/teacher/add-students')}}"><i class="lni lni-plus"></i> Add
                                 Students</a></li>-->
                         <li><a href="{{url('/dashboard/teacher/alumni')}}"><i class="lni lni-user"></i> Alumni's</a></li>
