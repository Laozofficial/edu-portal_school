...
<div class="container-fluid" v-show="content" id="show_content">
    <div class="form-head d-flex mb-3 align-items-start">
        <div class="mr-auto d-none d-lg-block">
            ...
            <p class="mb-0">Study Materials - Create and Update</p>
        </div>
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <v-select :options="sessions" label="name" v-model="selected_session"
                        :reduce="sessions => sessions.id" id="sessions">
                    </v-select>

                    <label class="text-left mt-2 mt-3">Select Class</label>
                    <v-select :options="levels" label="name" v-model="selected_level"
                       @input="get_subjects"  :reduce="levels => levels.id" id="level">
                    </v-select>
                     ...
                     <button class="btn btn-primary btn-block btn-sm" @click="save_material">
