...
<div class="container-fluid" v-show="content" id="show_content">
    <div class="form-head d-flex mb-3 align-items-start">
        <div class="mr-auto d-none d-lg-block">
            <h2 class="text-black font-w600 mb-0">Submit Assignment Answers</h2>
            <p class="mb-0">Assignment Solution</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <label class="mt-5">Upload the Assignment - <span class="text-danger">must be in .docx,.txt,.pdf Forma</span></label>
                            <input class="form-control form-control-sm form-control-file" type="file" @change="onAssignmentChange"/>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="viewDoc" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe :src="assignment.full_path_link" height="500" width="100%"></iframe>
                </div>
