...
<div class="container-fluid" v-show="content" id="show_content">
    <div class="form-head d-flex mb-3 align-items-start">
        <div class="mr-auto d-none d-lg-block">
            <h2 class="text-black font-w600 mb-0">Leave Type</h2>
            <p class="mb-0">Create , Update Leave Type</p>
        </div>
            ...
            <div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
                ...
                <div class="text-left ml-3">
                    ...
                    <v-select :options="institutions" label="name" v-model="selected_institution"
                        :reduce="institutions => institutions.id" @input="get_leave_types" id="institution"></v-select>
                </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <input class="form-control form-control-sm mb-3" type="number" v-model="total_days" id="exampleInputEmail1" aria-describedby="emailHelp"/>
                    <small
                        id="emailHelp" class="form-text text-muted mb-3">Calculated in days.</small>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-xs" @click="save_update(leave_type.id)">Update</button>
                </div>
            </div>
        </div>
    </div>
