                                  ...
                                  <div class="containe">
                                      ...
                                      <div class="card shadow-lg">
                                          <div class="card-body">
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <a class="text-primary" href="/dashboard/student/auth/login"><i class="fa fa-graduation-cap"></i> Student Login</a>
                                                  </div>
                                                  <div class="col-md-6 text-right">
                                                      <a href="/dashboard/teacher/auth/login" class="text-primary"><i class="fa fa-book"></i>Teacher Login</a>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
