            ...
            <div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
                ...
                <div class="text-left ml-3">
                    ...
                    <v-select :options="institutions" label="name" v-model="selected_institution"
                        :reduce="institutions => institutions.id" @input="get_alumni" id="institution"></v-select>
                </div>
                                    ...
                                    <table class="table table-responsive-md">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><strong>Last Recorded Class</strong></th>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                     <button class="btn btn-danger  btn-xs shadow"
                                                         @click="remove_as_alumni(student.id)">
                                                         <i class="fa fa-graduation-cap"></i> Remove as Alumni
                                                     </button>
                                                 </td>
                                            </tr>
                                        </tbody>
